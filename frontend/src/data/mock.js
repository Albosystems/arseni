...
export const testimonialsData = [
  ...
  },
  {
    ...
    quote: "Ich dachte, mit Mitte 50 ist der Zug abgefahren. Weniger Energie, mehr Bauch, keine Lust mehr. Mein Hausarzt sagte: 'Das ist normal in Ihrem Alter.' Mein Sohn hat mir gezeigt, dass das Bullshit ist.",
    results: [
      "Beste Form mit 55",
      "Energie wie mit 35",
    ...
    fullStory: "Mit 55 hatte ich mich fast damit abgefunden: Der Bauch wächst, die Energie schwindet, und die Libido war auch nicht mehr das, was sie mal war. Mein Hausarzt meinte nur: 'Das ist eben so in Ihrem Alter. Willkommen im Club.' Ich habe das jahrelang geglaubt und mich damit arrangiert. Dann hat mein Sohn Arseni angefangen, sich intensiv mit dem Thema Männergesundheit zu beschäftigen – und hat mir direkt gesagt: 'Papa, das ist nicht normal – das ist nur normal für Männer, die nichts dagegen tun.' Wir haben meine Hormone gecheckt – Testosteron war im Keller, genau wie ich mich gefühlt habe. Aber anstatt mir direkt TRT zu verschreiben, haben wir zuerst an den Grundlagen gearbeitet: Schlaf optimiert, Stress gemanagt, Ernährung angepasst und die richtigen Supplements eingeführt. Das Training haben wir so aufgebaut, dass es meinen Körper unterstützt statt ihn zu überlasten. Nach 3 Monaten war ich wie ausgewechselt: Bauchfett runter, Muskeln aufgebaut, Energie den ganzen Tag über, und auch im Schlafzimmer läuft es wieder. Ich bin jetzt mit 55 in besserer Form als mit 40. Ich bin stolz auf meinen Sohn – und auf das, was wir zusammen erreicht haben."
  },
  {
    id: 5,
    name: "Daniel",
  ...
  steps: [
    {
      ...
      description: "Am Anfang schauen wir uns an, wo du wirklich stehst: Alltag, Schlaf, Stress, Ernährung, Training, Beschwerden und deine bisherigen Versuche. Ziel ist nicht, dir \"noch mehr Wissen\" zu geben, sondern eine saubere Ausgangslage zu schaffen, auf der wir ein System aufbauen können, das zu dir passt.",
      duration: "Tag 1–3"
    },
    {
      phase: "System-Setup",
